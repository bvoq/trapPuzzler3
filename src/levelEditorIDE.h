...
float ideWidth = -1, prevIdeWidth = -2;
int ideLongestSentence = -1, prevIdeLongestSentence = -2;

ofTrueTypeFont ideFont; //License see 1.4 http://theleagueof.github.io/licenses/ofl-faq.html
...
/*
void changeCursorToCharacterSelectedAtThisPos(int my, int mx) {
    for(int i = 0; i < ideString.size();++i) {
