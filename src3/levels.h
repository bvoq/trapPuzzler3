...
void loadLevelData() {
    levels.clear();
    if(!ofFile::doesFileExist(locationOfSavesLevels+"levels/levels")) {
        DEB("File containing the levels not found at location: " << (locationOfSavesLevels+"levels/levels"));
        assert(false);
    }
    else if(!ofFile::doesFileExist(locationOfSavesLevels+"levels/defaultlevels")) {
        DEB("File containing the levels not found at location: " << (locationOfSavesLevels+"levels/defaultlevels"));
        assert(false);
    }
    else {
        vector<string> lineswithcomments = ofSplitString(ofBufferFromFile(locationOfSavesLevels+"levels/levels"), "\n");
        ...
        vector<string> lines2withcomments = ofSplitString(ofBufferFromFile(locationOfSavesLevels+"levels/defaultlevels"), "\n");
...
void saveLevelData() {
    cout << "Saving world data to " << locationOfSavesLevels << "levels/levels" << endl;
    ofFile writefile(locationOfSavesLevels+"levels/levels",ofFile::WriteOnly);
