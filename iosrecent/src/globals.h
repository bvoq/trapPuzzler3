...
string locationOfResources = "";// for ios this is "", for rest this is "data/"
string locationOfSavesLevels = "data/"; //for ios this is: string(getenv("HOME")) +"/Library/Documents/";
