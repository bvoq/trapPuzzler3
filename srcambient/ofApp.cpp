...
void ofApp::setup(){
    ...
    string subdir = "/data/";///Library/Application Support/trappuzzler/";
    
    locationOfSavesLevels = string(home) + subdir;
    //locationOfSavesLevels = "~/Library/Application Support/";
    cout << "locationOfSavesLevels: "  << locationOfSavesLevels << endl;
    std::filesystem::path pathToSaveFile = locationOfSavesLevels; //string(home);
    ofDirectory iosdocuments(pathToSaveFile);
    ofDirectory saves("data/saves");
    cout << "sauce: " << saves.getAbsolutePath() << endl;
    ofDirectory lvls("data/levels");
