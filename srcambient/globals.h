...
string locationOfResources = "data/";// for ios this is "", for rest this is "data/"
string locationOfSavesLevels = "data/"; //later this is: string(getenv("HOME")) +"/Library/Documents/";
...
//See ofApps.cpp for operating system specifics
