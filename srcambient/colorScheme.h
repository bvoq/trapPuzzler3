...
colorScheme scheme0 (
    0xEEEE00, //PLAYERSELECTED 249,250   199,200  224,224  238.238
    0xEFEF8A, //PLAYERUNSELECTED  255,153  204,122=CC,7A  227,138=E3,8A  239,145
    0xE55A00, //ENEMY  255,100  204,80=0xCC5000 229,90=0xE55000
    0xE50000, //ENEMYSTROKE
    0x333333, //0x646464 //UNMOVABLE_ENEMY
    0x000000, //UNMOVABLE_ENEMYSTROKE
    0xFFC4C4, //LOVE
    0xFCA1A1, //LOVESTROKE
    0x5E534E, //GRAVITYMONSTER
    0x3C2200, //GRAVITYMONSTERSTROKE
    0x777777,//0xC8C8C8, //BACKGROUND
    0x555555, //BACKGROUND_LIGHT
    0x555555, //BACKGROUND_SHADED
    0x555555, //BACKGROUND_VOID
...
colorScheme schemebeforelighting (
    ...
    0x3C2200, //GRAVITYMONSTERSTROKE
    0xC8C8C8, //BACKGROUND
    0xBBBBBB, //BACKGROUND_LIGHT
    0xBBBBBB, //BACKGROUND_SHADED
    0xBBBBBB, //BACKGROUND_VOID
    0x9D9795, //0x5E534E, //0x0000FF, //LEVELSELECT
    0xDBDBDB, //0x9D9795, //0xAFFBFF, //0x5555FF, //LEVELSELECT_LIGHT
    0x646464, //MESSAGE
    0x000000, //MESSAGE_SHADED
...
void loadColorScheme() {
    if(lightmode) scheme = schemebeforelighting;
    else scheme = scheme0;
}
//ALTERNATIVE SCHEMES
